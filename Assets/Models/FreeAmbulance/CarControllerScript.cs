...
public class CarControllerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        currentSpeed = transform.GetComponent<Rigidbody>().velocity.magnitude * 3.6f; //mashin hal hazirki suretini chekir
        pitch = currentSpeed / TopSpeed; // maximal surete bolur
        transform.GetComponent<AudioSource>().pitch = pitch; //ve Sesi hemin tezliye uygun verir
    }
    void HandBrake()
    {
        ...
        if (braked)
        {
            WheelRL.brakeTorque = maxBrakeTorque * 10;
            WheelRR.brakeTorque = maxBrakeTorque * 10;
